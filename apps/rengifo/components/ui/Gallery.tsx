    ...
    >
      ...
      >
        <button
          ...
          className='text-rengifo-pastel hover:text-rengifo-amarillo absolute right-2 top-2 cursor-pointer text-2xl transition-colors'
          onClick={closeGallery}
        >
          <Minimize2 />
        </button>
        <div className='bg-rengifo-azul-darker flex h-[60vw] max-h-[70vh] w-full items-center justify-center'>
          <button
            ...
            className='group absolute left-2 top-1/2 -translate-y-1/2 cursor-pointer text-3xl'
            onClick={prev}
          >
            <ArrowBigLeft
              size={42}
          ...
          <Image
            {...images[currentIndex]}
            className='mx-auto max-h-[60vh] select-none object-contain'
            priority
          />
          <button
            aria-label='Next image'
            className='group absolute right-2 top-1/2 -translate-y-1/2 cursor-pointer text-3xl'
            onClick={next}
          >
            <ArrowBigRight
              size={42}
