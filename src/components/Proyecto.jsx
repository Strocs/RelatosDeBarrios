    	...
    	<section id="El Proyecto" className="proyecto">
          	...
          	<Title className={'proyecto__title'} title={'El Proyecto'}/>
						...
						<p className="proyecto__text">
							El proyecto busca promover y rescatar el valor patrimonial e histórico de los barrios y conjuntos habitacionales de conservación histórica, ligados al patrimonio industrial, destacando la experiencia social y patrimonial detrás de la vida de sus habitantes, la dimensión comunitaria que generan estos espacios, y los aspectos esenciales que existen dentro de su construcción y diseño arquitectónico.
						</p>
